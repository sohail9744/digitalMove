    ...
    <>
      ...
      <nav className="sticky top-0 left-0 right-0 z-50">
        ...
        <main className="flex bg-white h-20 justify-between items-center shadow-sm">
          ...
          {/* Button container */}
          <div className="hidden lg:flex justify-end lg:pr-9">
            <Buttons />
          </div>
      ...
      {isOpen && (
        <div className="flex flex-col items-center border justify-center p-2 bg-gradient-to-b  gap-4 transition-transform duration-1000 transform translate-y-0 slide-in-out">
          <div>
