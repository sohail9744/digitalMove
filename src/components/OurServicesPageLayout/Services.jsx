        ...
        <main className="bg-orange-100 border-t border-stone-300">
          ...
          <section className="flex justify-center flex-wrap flex-col items-center">
            <div className="flex justify-center flex-col items-center">
              ...
              <div className="font-popins font-semibold flex justify-center items-center flex-col mt-5 lg:text-4xl sm:text-lg sm:text-center">
                <h2>The kind of services that our company</h2>
                <h2>provides to our clients</h2>
              </div>
            </div>
            <section className="my-8 flex flex-wrap flex-row lg:gap-8 sm:  justify-center">
              <Card data={items} />
            </section>
          </section>
        </main>
